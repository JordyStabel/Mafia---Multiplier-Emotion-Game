...
namespace Affdex
{
    ...
    public class Detector : MonoBehaviour
    {
        ...
        /// </summary>
        public ImageResultsListener[] Listeners
        {
            get
            {
                if (listeners == null)
                {
                    listeners = Array.ConvertAll(GameObject.FindObjectsOfType(typeof(ImageResultsListener)), item => (ImageResultsListener)item);
                }
        ...
        private ImageResultsListener[] listeners;
